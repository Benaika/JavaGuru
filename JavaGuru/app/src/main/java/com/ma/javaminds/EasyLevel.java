...
import com.ma.javaminds.levels.Easy;
...
public class EasyLevel extends AppCompatActivity implements View.OnClickListener {
    ...
    int score = 0;
    int totalQuestions = Easy.questions.length;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnHomepage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(EasyLevel.this, com.ma.javaminds.DifficultyScreen.class);
                startActivity(intent);// Apply transition animation
            }
        });
        ...
        //btnSubmit.setBackgroundColor(this.getColor(R.color.black));
    ...
    public void onClick(View v) {
        ...
        if (clickedButton.getId() == R.id.btnSubmit) {
            ...
            if (selectedAnswer.equals(Easy.answers[currentQuestionIndex])) {
                score++;
            }
    ...
    void loadNewQuestion(){
        ...
        tvQuestions.setText(Easy.questions[currentQuestionIndex]);
        btnOptionA.setText(Easy.choices[currentQuestionIndex][0]);
        btnOptionB.setText(Easy.choices[currentQuestionIndex][1]);
        btnOptionC.setText(Easy.choices[currentQuestionIndex][2]);
        btnOptionD.setText(Easy.choices[currentQuestionIndex][3]);
    }
    void finishQuiz() {
