...
public class HardScreen extends AppCompatActivity implements View.OnClickListener{
    ...
    int score = 0;
    int totalQuestions = Hard.questions.length;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnHomepage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(HardScreen.this, com.ma.javaminds.DifficultyScreen.class);
    ...
    public void onClick(View v) {
        ...
        if(clikedButton.getId() == R.id.btnSubmit){
            ...
            if(selectedAnswer.equals(Hard.answers[currentQuestionIndex])){
                score++;
            }
    ...
    void loadNewQuestion(){
        ...
        tvQuestions.setText(Hard.questions[currentQuestionIndex]);
        btnOptionA.setText(Hard.choices[currentQuestionIndex][0]);
        btnOptionB.setText(Hard.choices[currentQuestionIndex][1]);
        btnOptionC.setText(Hard.choices[currentQuestionIndex][2]);
        btnOptionD.setText(Hard.choices[currentQuestionIndex][3]);
    }
    void finishQuiz() {
        if (!isFinishing()) {
